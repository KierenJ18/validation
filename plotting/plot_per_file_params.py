...
for subfolder in subfolders:
    ...
    try:
        ...
        x_labels = ['npmt20', 'npmtm', 'npmtod', 'WCCylRadius', 'WCCylLength']
       
        
        # Plot various parameters
        for i in range(len(per_file.fields)):
            list_keys = list(per_file.fields)
            ...
            per_file_filtered = ak.flatten(per_file[list_keys[i]].compute(), axis=None)
